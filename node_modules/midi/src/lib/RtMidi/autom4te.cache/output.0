...
@%:@ Generated by GNU Autoconf 2.69 for RtMidi 2.0.1.
@%:@
...
PACKAGE_STRING='RtMidi 2.0.1'
PACKAGE_BUGREPORT='gary@music.mcgill.ca'
PACKAGE_URL=''

ac_unique_file="RtMidi.cpp"
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures RtMidi 2.0.1 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root @<:@DATAROOTDIR/doc/rtmidi@:>@
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of RtMidi 2.0.1:";;
   esac
  cat <<\_ACEOF
...
Optional Packages:
  ...
  --with-alsa = choose native ALSA sequencer API support (linux only)
  --with-core = choose CoreMidi API support (mac only)
  --with-winmm = choose Windows MultiMedia (MM) API support (windoze only)
  --with-winks = choose kernel streaming support (windoze only)
...
It was created by RtMidi $as_me 2.0.1, which was
...
ac_config_files="$ac_config_files rtmidi-config librtmidi.pc Makefile tests/Makefile"
...
if test "${enable_debug+set}" = set; then :
  enableval=$enable_debug; cppflag=-D__RTMIDI_DEBUG__ 
 cxxflag=-g 
 object_path=Debug 
 { $as_echo "$as_me:${as_lineno-$LINENO}: result: yes" >&5
$as_echo "yes" >&6; }
...
sharedlib="librtmidi.so" 

sharedname="librtmidi.so.\$(RELEASE)" 
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for MIDI API" >&5
$as_echo_n "checking for MIDI API... " >&6; }
case $host in
  *-*-linux*)
...
_ACEOF
  ...
  as_fn_error $? "ALSA sequencer support requires the asound library!" "$LINENO" 5
fi
...
_ACEOF
  ...
  as_fn_error $? "RtMidi requires the pthread library!" "$LINENO" 5
fi
...
if test "${with_core+set}" = set; then :
  withval=$with_core; 
    ...
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: using CoreMidi" >&5
$as_echo "using CoreMidi" >&6; }
    ac_fn_c_check_header_mongrel "$LINENO" "CoreMIDI/CoreMIDI.h" "ac_cv_header_CoreMIDI_CoreMIDI_h" "$ac_includes_default"
if test "x$ac_cv_header_CoreMIDI_CoreMIDI_h" = xyes; then :
  
else
  as_fn_error $? "CoreMIDI header files not found!" "$LINENO" 5 
fi
...
@%:@ Check whether --with-winmm was given.
if test "${with_winmm+set}" = set; then :
  withval=$with_winmm; 
    api="$api -D__WINDOWS_MM__"
    { $as_echo "$as_me:${as_lineno-$LINENO}: result: using WinMM" >&5
$as_echo "using WinMM" >&6; }
    LIBS=-lwinmm 
...
@%:@ Check whether --with-winks was given.
if test "${with_winks+set}" = set; then :
  withval=$with_winks; 
    api="$api -D__WINDOWS_KS__"
    LIBS="-lsetupapi -lksuser" 

    { $as_echo "$as_me:${as_lineno-$LINENO}: result: using kernel streaming" >&5
$as_echo "using kernel streaming" >&6; } 
fi
...
$as_echo "using WinMM" >&6; }
  ...
  *)
  ...
  as_fn_error $? "Unknown system type for MIDI support!" "$LINENO" 5
  ;;
esac
...
ac_log="
This file was extended by RtMidi $as_me 2.0.1, which was
generated by GNU Autoconf 2.69.  Invocation command line was
...
do
  case $ac_config_target in
    "rtmidi-config") CONFIG_FILES="$CONFIG_FILES rtmidi-config" ;;
    "librtmidi.pc") CONFIG_FILES="$CONFIG_FILES librtmidi.pc" ;;
